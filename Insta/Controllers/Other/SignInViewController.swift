...
class SignInViewController: UIViewController, UITextFieldDelegate {
    ...
    private let createAccontButton: UIButton = {
        let button = UIButton()
    ...
    override func viewDidLayoutSubviews() {
        ...
        createAccontButton.frame = CGRect(
            x: 35,
        ...
        termsButton.frame = CGRect(
            x: 35,
            y: createAccontButton.bottom+50,
            width: view.width-70,
            height: 40
        )
    ...
    private func addSubviews () {
        ...
        view.addSubview(createAccontButton)
    ...
    private func addButtonActions() {
        ...
        createAccontButton.addTarget(self, action: #selector(didTapCreateAccount), for: .touchUpInside)
